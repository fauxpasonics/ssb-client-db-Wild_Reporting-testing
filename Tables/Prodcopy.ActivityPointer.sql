...
[CopyLoadDate] [datetime] NULL CONSTRAINT [DF__ActivityP__CopyL__3A81B327] DEFAULT (getdate())
)
GO
ALTER TABLE [Prodcopy].[ActivityPointer] ADD CONSTRAINT [PK__Activity__0FC8C7C48032EAF0] PRIMARY KEY CLUSTERED  ([activityid])
GO
