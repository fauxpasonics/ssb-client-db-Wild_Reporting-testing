...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__SystemUse__copyl__3B40CD36] DEFAULT (getdate())
)
GO
ALTER TABLE [ProdcopyStg].[SystemUser] ADD CONSTRAINT [PK__SystemUs__E4276C1FF6CDF9EC] PRIMARY KEY CLUSTERED  ([systemuserid])
GO
