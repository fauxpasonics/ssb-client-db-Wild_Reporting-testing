...
[CopyLoadDate] [datetime] NULL CONSTRAINT [DF__Account__CopyLoa__4AB81AF0] DEFAULT (getdate())
)
GO
ALTER TABLE [Prodcopy].[Account] ADD CONSTRAINT [PK__Account__F20699F6147FA29D] PRIMARY KEY CLUSTERED  ([accountid])
GO
