...
[CopyLoadDate] [datetime] NULL CONSTRAINT [DF__CustomerA__CopyL__619B8048] DEFAULT (getdate())
)
GO
ALTER TABLE [Prodcopy].[CustomerAddress] ADD CONSTRAINT [PK__Customer__B4F00315BD4DAFC2] PRIMARY KEY CLUSTERED  ([customeraddressid])
GO
