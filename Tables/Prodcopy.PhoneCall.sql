...
[CopyLoadDate] [datetime] NULL CONSTRAINT [DF__PhoneCall__CopyL__5812160E] DEFAULT (getdate())
)
GO
ALTER TABLE [Prodcopy].[PhoneCall] ADD CONSTRAINT [PK__PhoneCal__0FC8C7C456DC171C] PRIMARY KEY CLUSTERED  ([activityid])
GO
